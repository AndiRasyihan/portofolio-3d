...
const I18N = {
  id: {
    ...
    c_linux: "Sertifikat kelulusan course NDG Linux Unhatched di Cisco Networking Academy.",
    c_uiux: "Sertifikat penghargaan sebagai Juara 1 dalam kompetisi desain UI/UX.",
    c_undipa: "Piagam penghargaan Lomba Teknologi 2022 di Universitas Dipa Makassar.",
    c_bc: "Sertifikat partisipasi bootcamp / pelatihan teknologi.",
    c_if: "Sertifikat penghargaan akademik / kompetisi Informatika.",
    c_general1: "Sertifikat pencapaian & partisipasi.",
    c_general2: "Sertifikat penghargaan & prestasi lainnya.",
    k_journey: "05 // PERJALANAN",
  ...
  en: {
    ...
    c_linux: "Certificate of completion for NDG Linux Unhatched course at Cisco Networking Academy.",
    c_uiux: "Award certificate for winning 1st place in the UI/UX design competition.",
    c_undipa: "Award charter for Technology Competition 2022 at Dipa University Makassar.",
    c_bc: "Certificate of participation for technology bootcamp / training.",
    c_if: "Academic / Informatics competition award certificate.",
    c_general1: "Certificate of achievement & participation.",
    c_general2: "Other awards & achievement certificates.",
    k_journey: "05 // JOURNEY",
